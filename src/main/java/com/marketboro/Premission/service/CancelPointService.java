...
public class CancelPointService {
    ...
    @Autowired
    public CancelPointService(MemberRepository memberRepository, HistoryRepository historyRepository, CancelQueueSender cancelQueueSender) {
